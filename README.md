...
| 사진                                                      | 사진                                                      | 사진                                                      | 사진                                                      |
| moeyg                                                     | Hongryeoll                                                | ujin16                                                    | aydenote                                                  |
| 로그인, 회원가입, 프로필 수정, 에러 | ![FrontEnd](https://img.shields.io/badge/FrontEnd-3f97fb) | ![FrontEnd](https://img.shields.io/badge/FrontEnd-3f97fb) | ![FrontEnd](https://img.shields.io/badge/FrontEnd-3f97fb) |
...
|                            6. 좋아요                            |                            7. 신고하기                            |
| :-------------------------------------------------------------: | :---------------------------------------------------------------: |
| <img src="asset/images/gif/like.gif" width="230" height="400"/> | <img src="asset/images/gif/accuse.gif" width="230" height="400"/> |
...
- 이슈 :
- 내 프로필과 상대방 프로필 페이지 html 파일을 나누지 않고 하나의 html 파일에서 동적으로 마크업 ⇒ 내 프로필과 상대방 프로필 페이지 마크업이 유사하고 기능 또한 비슷한 부분이 많아서 하나의 profile 페이지로 구현.
-
