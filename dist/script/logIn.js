...
// 로그인 데이터 요청
export function getLogInData(email, password, alertPEl, formEl) {
    return __awaiter(this, void 0, void 0, function () {
        var url, userIdPw, setting, resLogin, resresLoginJson, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("".concat(url, "/user/login"), setting)];
                case 2:
                    resLogin = _a.sent();
                    return [4 /*yield*/, resLogin.json()];
                case 3:
                    resresLoginJson = _a.sent();
