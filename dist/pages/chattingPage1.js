...
var ChattingPage1 = /** @class */ (function () {
    function ChattingPage1() {
    }
    ChattingPage1.prototype.render = function (content) {
        // header
        ...
        var chatIn3ArticleEl = document.createElement('article');
        var chatIn3ProfileImgEl = document.createElement('img');
        var chatIn3SectionEl = document.createElement('section');
        var chatIn3TextPEl = document.createElement('p');
        var chatIn3DatePEl = document.createElement('p');
        ...
        var chatOut2ArticleEl = document.createElement('article');
        var chatOut2SectionEl = document.createElement('section');
        var chatOut2TextPEl = document.createElement('p');
        var chatOut2DatePEl = document.createElement('p');
